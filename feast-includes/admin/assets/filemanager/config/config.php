...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $root,

	// 'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://localhost/feast',
	...
	|
	*/
	'upload_dir' => '/feast-content/uploads/',
	...
	|
	*/
	'current_path' => '../../../../feast-content/uploads/',
	...
	|
	*/
	'thumbs_base_path' => '../../../../feast-content/thumbs/',
	...
	*/
	...
	//******************
	'file_per_page'                           => 30,
	'delete_files'                            => $site_demo == TRUE ? false : true,
	'create_folders'                          => false,
	'delete_folders'                          => false,
	'upload_files'                            => $site_demo == TRUE ? false : true,
	'rename_files'                            => $site_demo == TRUE ? false : true,
	'rename_folders'                          => false,
	'duplicate_files'                         => $site_demo == TRUE ? false : true,
	'copy_cut_files'                          => $site_demo == TRUE ? false : true, // for copy/cut files
	...
	'edit_text_files'                         => $site_demo == TRUE ? false : true, // eg.: txt, log etc.
	'create_text_files'                       => $site_demo == TRUE ? false : true, // only create files with exts. defined in $editable_text_file_exts
	'view_dirs'                            	  => false,
	 ...
	 * JAVA upload
	 *******************/
	'java_upload'                             => $site_demo == TRUE ? false : true,
	...
	'fixed_path_from_filemanager'             => array( '../../../../feast-content/thumbs/', '../../../../feast-content/thumbs/', '../../../../feast-content/thumbs/', '../../../../feast-content/thumbs/' ), //fixed path of the image folder from the current position on upload folder
