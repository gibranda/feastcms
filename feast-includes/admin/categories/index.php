          <div class="row">
            <div class="col-md-8 col-sm-12">
              <div class="box">
                <div class="box-body">
                  <?php echo form_open('admin/categories/delete_multi'); ?>
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th><?=feast_line('slug')?></th>
                        <th><?=feast_line('order')?></th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?=cat_order($cat)?></td>
                        <td>
                          <a href="<?=base_url('admin/categories/edit/' . cat_id($cat))?>" class="label label-info" data-toggle="tooltip" data-title="<?=feast_line('edit', $this->lang->line('page') )?>"><i class="fa fa-lg fa-pencil"></i></a>
                          <a onClick="javascript:return confirm('<?=feast_line('delete_confirm_msg')?>');" href="<?=base_url('admin/categories/delete/' . cat_id($cat))?>" class="label label-danger" data-toggle="tooltip" data-title="<?=feast_line('delete', $this->lang->line('page') )?>"><i class="fa fa-lg fa-trash"></i></a> 
                        </td>
                      </tr>
                      <?php endforeach; ?>
            ...
            <div class="col-md-4 col-sm-12">
    				...
    				<div class="box box-primary">
    				  <div class="box-header with-border">
    				    <h3 class="box-title"><?=feast_line('add', $this->lang->line('category') )?></h3>
    				  </div><!-- /.box-header -->
    				  <?=form_open('admin/categories/edit', array('class' => 'form'))?>
    				  <div class="box-body">
