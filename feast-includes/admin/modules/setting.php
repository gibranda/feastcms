...
label .help-block {
  ...
  line-height: 1.1;
    ...
    <?php echo form_open_multipart(base_url('admin/module/update')); ?>
    <div class="row">
      <div class="col-lg-12 col-md-12">
          <div class="box">
              <div class="box-body">
                  ...
                  <?php
                    $setting_file = FCPATH . 'feast-content/modules/' . $module . '/setting.php';
                    if(file_exists($setting_file)) {
                      $this->load->ext_view('../feast-content', 'modules/' . $module . '/setting', TRUE);
                    } else {
