...
function bs_media_body( $atts, $content = null ) {
  ...
  register_shortcode_css(array(
    base_url('feast-content/themes/themeone/assets/lib/bootstrap/dist/css/bootstrap.min.css'), 
    base_url('feast-content/themes/themeone/assets/lib/animate.css/animate.css'), 
    base_url('feast-content/themes/themeone/assets/lib/components-font-awesome/css/font-awesome.min.css'), 
    base_url('feast-content/themes/themeone/assets/lib/flexslider/flexslider.css'), 
    base_url('feast-content/themes/themeone/assets/css/colors/default.css'), 
    base_url('feast-content/themes/themeone/assets/css/style.css'),
    base_url('feast-content/themes/themeone/assets/lib/et-line-font/et-line-font.css')
  ));